    ...
    return (
      <motion.div className="tools-page">
        ...
        <motion.div initial={{ display: "none" }} animate={{
          ...
          <div className="tools-header"><div className="back-contact"><Link to={"/home"}><img src={require("./back.png")} alt="" /></Link></div><svg width="401" height="151" viewBox="0 0 401 151" fill="none" xmlns="http://www.w3.org/2000/svg" >
